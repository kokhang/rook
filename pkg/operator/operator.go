...
func New(context *clusterd.Context) *Operator {
	...
	volumeProvisioner := provisioner.NewRookVolumeProvisioner(context.Clientset)
...
func (o *Operator) Run() error {
	...
	o.clusterController.Watch(v1.NamespaceAll, stopChan)
...
func (o *Operator) initResources() error {
	for _, resource := range o.resources {
		err := kit.CreateCustomResource(resource, o.context.Clientset)
		if err != nil {
			return fmt.Errorf("failed to create CRD %s. %+v", resource.Name, err)
		}
	}
	return nil
}
