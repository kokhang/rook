...
func NewPoolController(kubeClient kubernetes.Interface) (*PoolController, error) {
...
func (c *PoolController) Watch(namespace string, stopCh chan struct{}) error {
	...
	rclient, err := api.GetRookClient(namespace, c.kubeClient)
	if err != nil {
