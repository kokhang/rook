...
// NewAPIExtensionsClientset creates a Kubernetes API Extesion clientset for CRD management
func NewAPIExtensionsClientset() (apiextensionsclient.Interface, error) {
